...
3. GIVE INTERNET ACCESS TO START, NO LOGIN REQUIRED 
4. ONCE OPENED YOU CAN SEE THE FIX MY WIFI BUTTON YOU CAN CLICK ON IT TO INSTANTLY RESOLVE WIFI ISSUES ON YOUR DEVICE
5. APART FROM THIS YOU CAN USE MANY FEATURES ON THE APP AS SEEN ON DASHBOARD 
6. THE APP HAS NO LOGIN REQUIRED ONLY FOR EASY ACCESS NOW. THE APP WILL EVOLVE WITH TIME.
